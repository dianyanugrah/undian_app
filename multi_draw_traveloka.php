...
if(isset($_GET['q'])) {
	...
	if($_GET['q'] == 'o') {
		...
		$update_stat_pemenang = "UPDATE pemenang_tb SET stat = 2 WHERE jenis_hadiah = 2 AND jenis_undian = 1";
		...
		if($_GET['u'] == 1) {
			// echo "Undian 1;
			$filename = "Data_Pemenang_Traveloka_Multi_Draw".date('YmdHis').".xlsx";
			$rows = $listNew;
		}
	} else if($_GET['q'] == 'ek') {
		...
		<div class="main-area center-text" style="background-image:url(assets/images/gambar3.png);">
			...
			<div class="display-table">
				<div class="display-table-cell">
					...
					<h3 class="title"><b>HADIAH TRAVELOKA VOUCHER</b></h3>
					...
					<ul id="tools" class="social-btn">
						...
						<li><a id="singledraw" style="background-color: #FF8C00; padding-right: 15px" href="single_draw_traveloka.php"><i class="ion-shuffle"></i> Single Draw Traveloka</a></li>
							...
							<div class="col-md-12">
								<div class="panel panel-primary">
								  	...
								  	<div class="panel-footer">
								  		<a href="multi_draw_traveloka.php?q=ek" id="export_kota" style="background-color: #DAB000; color: #fff; padding: 15px"><i class="ion-android-arrow-down"></i> Export Data</a>
								  	</div>
								</div>
							</div>								
						</div>
        ...
        $('#reset').click(function() {
        	if(flagWinner === 1) {
	        	if (confirm('Anda ingin memulihkan data pemenang undian ?')) {
				    window.location.href = "multi_draw_traveloka.php?q=r";
