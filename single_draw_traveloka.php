...
if(isset($_GET['q'])) {
	...
	if($_GET['q'] == 'o') {
		...
		$update_stat_pemenang = "UPDATE pemenang_tb SET stat = 2 WHERE jenis_hadiah = 2 AND jenis_undian = 2";
		...
		if($update_stat_pemenang_exec) {
			...
			header('Location: single_draw_traveloka.php');
		}
	} else if($_GET['q'] == 'p') {
		// echo "Export Data Pemenang";
		if($_GET['u'] == 1) {
			// echo "Undian 1;
			$filename = "Data_Pemenang_Traveloka_Single_Draw".date('YmdHis').".xlsx";
			$rows = $listNew;
		}
	} else if($_GET['q'] == 'ek') {
		...
		<div class="main-area center-text" style="background-image:url(assets/images/gambar3.png);">
			...
			<div class="display-table">
				<div class="display-table-cell">
					...
					<h3 class="title"><b>TRAVELOKA VOUCHER</b></h3>
					<p class="desc font-white">Pengundian hadiah Traveloka Voucher</p>
					...
					<ul id="tools" class="social-btn">
						...
						<li><a id="singledraw" style="background-color: #FF8C00; padding-right: 15px" href="multi_draw_traveloka.php"><i class="ion-shuffle"></i>Multi Draw Traveloka</a></li>
				...
				<div class="display-table-cell">
					...
					<table class="table table-bordered">
					    ...
					    <tbody id="export_btn" style="display: none">
					      	<tr>
					      		<td colspan="7">
					      			<a href="single_draw_traveloka.php?q=p&u=1" id="export_winner" style="background-color: #DAB000; color: #fff; padding: 15px"><i class="ion-android-arrow-down"></i> Export Data Pemenang</a>
					      		</td>
					      	</tr>
					    </tbody>
				  	</table>
							...
							<div class="col-md-12">
								<div class="panel panel-primary">
								  	...
								  	<div class="panel-footer">
								  		<a href="single_draw_traveloka.php?q=ek" id="export_kota" style="background-color: #DAB000; color: #fff; padding: 15px"><i class="ion-android-arrow-down"></i> Export Data</a>
								  	</div>
								</div>
							</div>								
						</div>
        ...
        $('#reset').click(function() {
        	if(flagWinner === 1) {
	        	if (confirm('Anda ingin memulihkan data pemenang undian ?')) {
				    window.location.href = "single_draw_traveloka.php?q=r";
